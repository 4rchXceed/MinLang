...
See more at [The documentation](https://4rchxceed.github.io/MinLang-docs/ZedLangSupport/Index)
...
#### Note: this script requires python to be install AND will edit automatically your "index.json" file
#### If it detects NixOS, it will automatically shell with python3
Run:
```bash
./install.sh
```
