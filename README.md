...
See the [Wiki](https://github.com/4rchXceed/MinLang-docs) for installation instructions and detailed documentation.

## License

MinLang is licensed under the 3-Clause BSD License. See the [LICENSE](LICENSE) file for more information.
